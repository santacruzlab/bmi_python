...
def update_var(compliant_te, te_for_grasp_class=None, te_for_emg_decoder=None):
    ...
    if te_for_emg_decoder is not None:
        emg_id = dbfn.TaskEntry(te_for_emg_decoder)
        emg_id = models.Decoder.objects.get(pk=emg_id.emg_decoder)
        emg_decoder_path = '/storage/decoders/'+emg_id.path
    ...
    if te_for_grasp_class is not None:
